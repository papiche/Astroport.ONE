...
* Exécution : NOSTRCARD.refresh.sh, PLAYER.refresh.sh, UPLANET.refresh.sh (_UPLANET.refresh.sh désactivé).
...
5. **Zones géographiques** : UPLANET.refresh.sh, SECTOR.refresh.sh, REGION.refresh.sh.
6. **Sécurité et Accès** :
