...
1. [Vue d'ensemble](TODO_SYSTEM.md#1-vue-densemble)
2. [Architecture](TODO_SYSTEM.md#2-architecture)
3. [todo.sh — Référence complète](TODO_SYSTEM.md#3-todosh--référence-complète)
   * [Périodes d'analyse](TODO_SYSTEM.md#31-périodes-danalyse)
   * [Commandes mémoire N²](TODO_SYSTEM.md#32-commandes-mémoire-n)
   * [Publication](TODO_SYSTEM.md#33-publication)
   * [Options avancées](TODO_SYSTEM.md#34-options-avancées)
4. [Flux d'exécution détaillé](TODO_SYSTEM.md#4-flux-dexécution-détaillé)
5. [Système de mémoire N²](TODO_SYSTEM.md#5-système-de-mémoire-n)
6. [Système de publication](TODO_SYSTEM.md#6-système-de-publication)
   * [NOSTR kind 30023](TODO_SYSTEM.md#61-nostr-kind-30023)
   * [Open Collective](TODO_SYSTEM.md#62-open-collective)
   * [N² Memory (kind 31910)](TODO_SYSTEM.md#63-n-memory-kind-31910)
   * [Global Commons (UMAP 0.00, 0.00)](TODO_SYSTEM.md#64-global-commons-umap-000-000)
7. [generate\_article.sh — Référence complète](TODO_SYSTEM.md#7-generate_articlesh--référence-complète)
8. [Intégration todo.sh ↔ generate\_article.sh](TODO_SYSTEM.md#8-intégration-todosh--generate_articlesh)
9. [Configuration requise](TODO_SYSTEM.md#9-configuration-requise)
10. [Exemples d'utilisation](TODO_SYSTEM.md#10-exemples-dutilisation)
11. [Dépannage](TODO_SYSTEM.md#11-dépannage)
...
L'option `--export` appelle [`generate_article.sh`](https://github.com/papiche/Astroport.ONE/blob/master/docs/IA/generate_article.sh) après génération du rapport pour produire une version éditorialisée dans le format désiré.
...
L'option `--no-image` désactive la génération d'image. Si ComfyUI est absent, `generate_article.sh` continue sans erreur (image\_url = "").
...
* [`code_assistant_DOC.md`](https://github.com/papiche/Astroport.ONE/blob/master/docs/code_assistant_DOC.md) — Assistant IA pour l'analyse de code
* [`plans/todo_code_assistant_integration.md`](https://github.com/papiche/Astroport.ONE/blob/master/plans/todo_code_assistant_integration.md) — Feuille de route des phases 2-4
