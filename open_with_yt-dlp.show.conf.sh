...
# Musique/DJ Mix (tracklist auto-extraite des chapitres YouTube, un fichier MP3 par morceau)
python3 $HOME/.zen/Astroport.ONE/tools/youtube_dj_playlist_downloader.py -y --embed-thumbnail --embed-metadata
"
