...
*   💰 **Construir una Economía Real:** Usa la moneda libre Ğ1 (June) y nuestro sistema de contabilidad interno Ẑen para crear valor e intercambiarlo equitativamente.
...
*   **El Ẑen (Ẑ):** Para gestionar nuestros proyectos, usamos una unidad de contabilidad interna y estable llamada Ẑen. Dentro de nuestra cooperativa, **1 Ẑen = 1€**. Esto nos permite gestionar de manera transparente nuestros activos (servidores, dominios, etc.) y nuestros gastos.
...
**El Camino del Usuario (1 Ẑen/semana)**
...
*   **Lo que obtienes:**
    ...
    *   ✅ Una **Billetera Ẑen** para participar en la economía (¡gana Ẑen cuando tu contenido reciba likes!).
    *   ✅ **uDRIVE**, tu espacio de almacenamiento IPFS personal.

### 2. ☁️ [ZENCARD](https://ipfs.copylaradio.com/ipfs/QmQRreMYDHhAnkg7rwgYYdS5QDhvjjeBdozE16L3h5A8ED/zencard.html) - Tu Nube Soberana
**El Camino del Co-propietario (5 Ẑen/semana o compra de partes)**
...
Para aquellos que quieren estar en el corazón de la red. Un Captain ejecuta una Estación, proporciona servicios a otros usuarios, y gana Ẑen por su contribución.

*   **Lo que haces:**
    *   ✅ Transforma tu PC o Raspberry Pi en un nodo generador de valor.
    *   ✅ Únete a la **cooperativa CopyLaRadio** como proveedor técnico.
    *   ✅ Gana Ẑen alojando usuarios MULTIPASS y ZenCard.
...
## Una Historia de Dos Mundos: UPlanet ORIGIN vs. UPlanet Ẑen

El ecosistema UPlanet tiene dos "reinos" interconectados diseñados para diferentes propósitos.

| Característica | **UPlanet ORIGIN (La Puerta de Entrada Pública)** | ✅ **UPlanet Ẑen (La Red Cooperativa)** |
| :--- | :--- | :--- |
...
| **Acceso** | Abierto a todos con un email o cuenta Ğ1. | Reservado para **miembros cooperativos** (ZENCARD y Captains). |
| **Valor del Ẑen**| 1 Ẑen = 0.1 Ğ1 (una moneda de juego interna). | **1 Ẑen = 1€** (una unidad estable para nuestra economía real). |
| **Confianza**| Verificación de identidad básica. | Basada en la **Red de Confianza** Ğ1 y el pacto cooperativo legal. |
| **Identidad** | MULTIPASS básico. | **uPASSPORT Validado**, tu certificado de co-propiedad. |

---

## 🛠️ Comenzar: Conviértete en un Constructor
...
```
Este script configurará tu Estación Astroport.ONE. Al instalarlo, aparecerás automáticamente en el mapa swarm [UPlanet ORIGIN](https://ipfs.copylaradio.com/ipns/copylaradio). Para unirte a las redes cooperativas `UPlanet Ẑen`, necesitarás activar características avanzadas y convertirte en miembro.

## 📚 Documentación y Detalles Técnicos

Para aquellos que quieren profundizar en los aspectos técnicos de nuestro sistema.

*   **[🏗️ ARCHITECTURE.md](ARCHITECTURE.md)**: Una visión técnica completa del sistema, flujos de datos y modelos económicos.
...
*   **Descubre Ğ1:** Aprende más sobre [la mejor criptomoneda que podrías soñar](https://monnaie-libre.fr).
...
*   **🏆 Ventaja del Hardware Premium:** GPUs gaming de gama alta (RTX 4090, Mac Studio M2 Ultra) ganan proporcionalmente más Ẑen
