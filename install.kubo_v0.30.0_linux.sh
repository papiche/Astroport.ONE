...
if [ "$architecture" == "x86_64" ]; then
    wget --no-check-certificate -O kubo.tar.gz https://dist.ipfs.tech/kubo/v0.30.0/kubo_v0.30.0_linux-amd64.tar.gz
elif [ "$architecture" == "aarch64" ]; then
    wget --no-check-certificate -O kubo.tar.gz https://dist.ipfs.tech/kubo/v0.30.0/kubo_v0.30.0_linux-arm64.tar.gz
elif [ "$architecture" == "armv7l" || "$architecture" == "armv6l" ]; then
    wget --no-check-certificate -O kubo.tar.gz https://dist.ipfs.tech/kubo/v0.30.0/kubo_v0.30.0_linux-arm.tar.gz
else
