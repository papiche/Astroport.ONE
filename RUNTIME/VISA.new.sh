...
(
echo "<html><body><h1>UPlanet : ZenCard</h1>Print your ZenCard : Public key (and wallet address)" > ~/.zen/tmp/${MOATS}/intro.txt
...
echo "<html><body><h1>UPlanet : AstroID ($PASS)</h1>Print your AstroID : Private control key (secured by $PASS)" > ~/.zen/tmp/${MOATS}/intro.txt
