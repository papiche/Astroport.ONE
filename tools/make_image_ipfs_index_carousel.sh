...
##################
        ...
        && echo "<a href=\"javascript:homeAstroportStation('"$myASTROPORT"/?qrcode="$ASTRONAUTENS"', 'page', '3000')\" title=\"$PLAYER ($ZEN ZEN) PORTEFEUILLE Ğ1 \">_REPLACE_</a>" > ~/.zen/tmp/carousel/${pub}.insert \
