...
if [[ "$SOURCE_DIR" == *"/nostr"* ]]; then
    ...
    UMAP_DIR=$(dirname "$(dirname "$SOURCE_DIR")")
    OWNER_EMAIL=$(basename "$UMAP_DIR")
    OWNER_HEX_FILE="${UMAP_DIR}/HEX"
fi
...
<head>
    ...
    <title>UPLANET uDRIVE Explorer</title>
...
<body>
    ...
    function updateConnectionStatus(connected) {
        ...
        function openModalForApp(index) {
            ...
            // Load the app directly in the iframe and let the browser handle meta redirects
