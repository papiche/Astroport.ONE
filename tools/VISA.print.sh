...
if [[ $XDG_SESSION_TYPE == 'x11' || $XDG_SESSION_TYPE == 'wayland' ]] ; then
    ...
    $MY_PATH/../tools/mailjet.sh --channel zine --template "${MY_PATH}/../templates/UPlanetZINE/day0/index.html" --expire 0s "${PLAYER}" ~/.zen/tmp/${MOATS}/UPlanetZine.html "${PLAYER} ZENCARD"
fi
