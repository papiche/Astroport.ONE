...
show_video_details() {
    ...
    while true; do
        ...
        echo -e "${CYAN}─────────────────────────────────────────────────────────────────────────────${NC}"
        echo ""
        echo "  ${YELLOW}1.${NC} 🔄 Upgrade video (re-generate metadata)"
        echo "  ${YELLOW}2.${NC} 📋 Copy video URL to clipboard"
        echo "  ${YELLOW}3.${NC} 🖼️  Open thumbnail in browser"
        echo "  ${YELLOW}4.${NC} 🎬 Open animated GIF in browser"
        echo "  ${YELLOW}5.${NC} 📊 View info.json"
        echo "  ${YELLOW}6.${NC} 🗑️  Delete this video"
        echo "  ${YELLOW}b.${NC} 🔙 Back to video list"
        echo "  ${YELLOW}0.${NC} 🚪 Exit"
        echo ""
...
cmd_channel() {
    ...
    while true; do
        ...
        echo -e "${CYAN}╚════════════════════════════════════════════════════════════════════════════╝${NC}"
        echo ""
        echo "  1. 📋 List all videos"
        echo "  2. 📊 Show statistics"
        echo "  3. 🔍 Check metadata completeness"
        echo "  4. 🔄 Upgrade all videos (fix missing metadata)"
        echo "  5. 🗑️  Delete specific video"
        echo "  6. 🧹 Clean duplicate videos"
        echo "  7. 📤 Export channel data (JSON)"
