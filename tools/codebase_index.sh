...
#
# Usage :
#   ./tools/codebase_index.sh [--index] [--incremental] [--reset]
...
case "${1:-}" in
    ...
    --help|-h|help|"")
        ...
        echo "    ./tools/codebase_index.sh --index"
        echo ""
        echo "  Partage constellation :"
        echo "    ./tools/codebase_index.sh --snapshot    # nœud maître"
        echo "    ./tools/codebase_index.sh --restore CID # nœuds secondaires"
        echo ""
        ;;
