...
#
# Usage :
#   ./admin/ia_db/knowledge_index.sh [--index-nostr] [--index-udrive]
...
case "${1:-}" in
    ...
    --help|-h|help|"")
        ...
        echo ""
        echo "  Exemples :"
        echo "    ./admin/ia_db/knowledge_index.sh --index-nostr"
        echo "    ./admin/ia_db/knowledge_index.sh --index-dir ~/nextcloud/Astroport --skill devops"
        echo "    ./admin/ia_db/knowledge_index.sh --search 'introduction Docker conteneurs'"
        echo "    ./admin/ia_db/knowledge_index.sh --search 'linux' --skill linux"
        echo ""
