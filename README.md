...
*   **[🔐 docs/ORACLE_SYSTEM.md](docs/ORACLE_SYSTEM.md)**: **Permit & License Management** - Web of Trust competency certification with multi-signature attestation, Verifiable Credentials (VCs), NOSTR events, and Ẑen rewards from cooperative R&D fund.
