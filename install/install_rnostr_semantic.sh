...
#         - IA/services/ollama.me.sh  → connexion Ollama (local, SSH ou IPFS P2P swarm)
...
# à IA/services/ollama.me.sh (connexion Ollama via IPFS P2P swarm) et IA/embed.py.
...
echo "║  2. Connecter Ollama :  ~/.zen/Astroport.ONE/IA/services/ollama.me.sh   ║"
