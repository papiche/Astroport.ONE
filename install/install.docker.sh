...
# --- 1. Installation Docker conditionnelle ---
if command -v docker >/dev/null 2>&1; then
    echo -e "\033[0;32m✅ Docker est déjà installé, saut de l'installation.\033[0m"
else
    ...
    # Suppression des anciennes versions de Docker ### BAD HABIT
